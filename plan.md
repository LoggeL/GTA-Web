...
Last updated: 2026-07-16 23:27 CEST
Plan status: Active  
Current focus: publish the passing M8 preview, complete the 20-minute desktop/mobile soak and hardware-GPU check, then cut the final release
...
- Latest `npm run check`: M8 Preview 1 passed with 83 files / 525 Vitest tests plus 5 release tests; repeat after the v1.0.0 metadata bump remains required
- Latest browser smoke test: Chromium desktop/mobile 35 applicable scenarios passed with 27 intentional device skips; Firefox and WebKit release smokes passed 1/1 each; live desktop and 844×390 verification passed with exact JS/Three.js/CSS assets, hardware WebGL, and zero console warnings/errors. The 20-minute desktop/mobile soak and final-version deployment remain pending.
